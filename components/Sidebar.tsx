  ...
  return (
    <li
      ...
      className={`
        ...
        ${isActive ? 'bg-blue-800 text-white' : 'text-gray-300 hover:bg-blue-600 hover:text-white'}
      `}
    >
  ...
  return (
    <aside className="w-64 bg-primary text-white flex-col p-4 hidden md:flex">
      <div className="text-2xl font-bold mb-8 text-center">
        Indu<span className="text-secondary">Panel</span>
      </div>
      <nav>
        <ul>
          <NavItem 
          ...
          <NavItem 
            ...
            activeScreen={activeScreen} 
            setActiveScreen={setActiveScreen}
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2zm4 0V5a2 2 0 012-2h4a2 2 0 012 2v2M8 11h8m-8 4h4" /></svg>}
          />
          <NavItem 
            label="Reportes" 
            screen="reportes" 
